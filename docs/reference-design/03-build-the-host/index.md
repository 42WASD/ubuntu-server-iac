...
- [create the infrastructure repository first](create-the-infrastructure-repository-first/index.md)
- [inventory the actual machine](inventory-the-actual-machine/index.md)
- [update Ubuntu and install base administration tools](update-ubuntu-and-install-base-administration-tools/index.md)
  - [unattended security updates](update-ubuntu-and-install-base-administration-tools/unattended-security-updates/index.md)
- [hostname, DNS, and local identity](hostname-dns-and-local-identity/index.md)
- [users, groups, and sudo boundaries](users-groups-and-sudo-boundaries/index.md)
...
- [SSH hardening](ssh-hardening/index.md)
- [Tailscale private management path](tailscale-private-management-path/index.md)
  - [Tailscale policy concept](tailscale-private-management-path/tailscale-policy-concept/index.md)
- [host firewall](host-firewall/index.md)
- [system tuning and resource safety](system-tuning-and-resource-safety/index.md)
...
- [developer CPU/RAM/PID limits on the host](developer-cpu-ram-pid-limits-on-the-host/index.md)
- [storage architecture](storage-architecture/index.md)
...
- [filesystem quotas for developer homes](filesystem-quotas-for-developer-homes/index.md)
- [NVIDIA host driver baseline](nvidia-host-driver-baseline/index.md)
