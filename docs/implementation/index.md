...
**9 / 92** phases/sections complete (**10%**).

<div class="progress-row" style="max-width:720px;padding:8px 0;"><div class="progress-track"><div class="progress-fill progress-fill--shimmer" style="--w:9.8%"></div></div><div class="progress-pct">10%</div></div>
...
### 31% — Part III — Build the host

<div class="tip" style="display:flex;align-items:center;gap:8px;max-width:520px;padding:2px 0 10px;"><div class="progress-track"><div class="progress-fill" style="--w:31.0%"></div></div><div class="progress-pct" style="font-size:.85em;">31%</div><div class="tip-box"><strong>Done (9)</strong>
