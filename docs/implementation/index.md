...
**65 / 97** phases/sections complete (**67%**).

<div class="progress-row" style="max-width:720px;padding:8px 0;"><div class="progress-track"><div class="progress-fill progress-fill--shimmer" style="--w:67.0%"></div></div><div class="progress-pct">67%</div></div>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — sudo policy</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — platform groups</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — no shared human account</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — basic forwarding</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — inotify limits</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — journald bound</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — swap: disable for bring-up, then re-enable as a host safety net</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — required LVM module</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — existing-install path</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — desired logical layout</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — create dedicated RKE2 filesystem only when backing storage is known</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — Kubernetes fast VG</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — Kubernetes bulk VG</summary>
...
<div class="tip" style="display:flex;align-items:center;gap:8px;max-width:520px;padding:2px 0 10px;"><div class="progress-track"><div class="progress-fill" style="--w:100.0%"></div></div><div class="progress-pct" style="font-size:.85em;">100%</div><div class="tip-box"><strong>Done (13)</strong>
...
> HTTP 200 by hostname.
  ...
  - ✅ `done` — [Argo CD instance configuration](../reference-design/05-gitops-bootstrap/root-gitops-application/argocd-instance-config/index.md)

<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — Argo CD instance configuration</summary>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — example: deny hostPath</summary>
...
- 🔶 `in-progress` — [Phase 35 — metrics stack](../reference-design/08-monitoring-and-logs/metrics-stack/index.md)

<details markdown="1" class="runbook">
<summary>🔶 📜 Build log — metrics stack</summary>
...
<div class="tip" style="display:flex;align-items:center;gap:8px;max-width:520px;padding:2px 0 10px;"><div class="progress-track"><div class="progress-fill" style="--w:100.0%"></div></div><div class="progress-pct" style="font-size:.85em;">100%</div><div class="tip-box"><strong>Done (6)</strong>
...
<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — game server orchestration: operator, not raw manifests</summary>
...
- Research summary (Agones / OpenKruiseGame / gameserver-operator): see the
  ...
  - ✅ `done` — [Minecraft demo deployment](../reference-design/13-game-networking-foundation/game-server-orchestration-operator/minecraft-demo-deployment/index.md)

<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — Minecraft demo deployment</summary>
...
stack; the dev lane is dormant but intact.
  ...
  - ✅ `done` — [Cilium stale node-IP recovery](../reference-design/13-game-networking-foundation/game-server-orchestration-operator/cilium-stale-node-ip-recovery/index.md)

<details markdown="1" class="runbook">
<summary>✅ 📜 Build log — Cilium stale node-IP recovery</summary>
